...
public abstract class ComunicaServer {
    ...
    public void setEscuchadorDeNodoFisico(ConexionListener escuchadorDeNodoFisico) { // El concepto "escuchador" aca se
                                                                                     // usa como un actionlistener, ya
                                                                                     // que al que al que le
        this.escuchadorDeNodoFisico = escuchadorDeNodoFisico; // Similar a un observer, aunque de instancia unica y mas
                                                              // particular.
    }
